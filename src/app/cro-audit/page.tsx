        ...
        <section id="pricing" className="mt-14">
          ...
          <div className="mt-6 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
            {[
              ...
              { name: "Standard Plan", price: "$79.99", suffix: "/mo", cta: "Select Standard", dark: false, perks: ["10 audits included", "Full CRO audit of your submitted pages", "All audit elements included", "Audits are stored permanently", "White-label reports"] },
              { name: "Pro Plan", price: "$129.99", suffix: "/mo", cta: "Select Pro", dark: false, perks: ["20 audits included", "Full CRO audit of your submitted pages", "All audit elements included", "Audits are stored permanently", "White-label reports"] },
            ].map((plan) => (
              <article
                key={plan.name}
