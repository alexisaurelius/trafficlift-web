        ...
        <section id="pricing" className="mt-14">
          ...
          <div className="mt-6 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
            {[
              ...
              { name: "Starter plan", price: "$29.99", suffix: "/mo", cta: "Select Starter", badge: "Popular", dark: true, perks: ["3 audits included", "Full CRO audit of your submitted pages", "All audit elements included", "Audits are stored permanently", "Scheduled re-audits"] },
