...
const CRO_TOPICS: TopicConfig[] = [
  ...
  },
  {
    id: "funnel",
    label: "Funnel",
    keys: ["entry-experience", "hero-clarity", "cta-audit", "funnel-friction", "pricing-transparency"],
    icon: FileText,
  },
  {
    id: "trust",
    label: "Trust",
    keys: ["social-proof", "support-objections", "urgency-incentives", "value-proposition"],
    icon: ShieldCheck,
  },
  {
    id: "technical",
    label: "Technical",
    keys: ["technical-health", "analytics-tracking", "mobile-experience", "nav-architecture", "scroll-experience", "offer-communication"],
    icon: Settings,
  },
];
