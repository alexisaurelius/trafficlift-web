...
const STEPS = [
  {
    ...
    body: "We scan your funnel and key pages for conversion blockers and hesitation points.",
  },
  {
    title: "AI Evaluation",
    body: "Our models score UX friction, message clarity, and purchase-path drop-offs.",
  },
  {
    title: "Final Review",
  ...
  },
  {
    ...
    body: "Receive a practical optimization roadmap with quick wins and testing priorities.",
  },
];

export function CroProcessTimelineSection() {
  ...
  return (
    ...
    >
      <h2 className="text-center font-manrope text-2xl font-extrabold md:text-3xl">
        Clear Process to Boost Your Conversions
      </h2>
      <p className="mt-3 text-center text-[16px] text-white/70">Four steps to a higher-converting website.</p>
      ...
      <div className="relative mt-8">
        ...
        <div className="relative grid grid-cols-4 gap-4">
          {["1", "2", "3", "4"].map((step, idx) => {
            ...
            return (
              <div key={step} className="flex justify-center" onMouseEnter={() => setHoveredStep(idx + 1)}>
                <span
