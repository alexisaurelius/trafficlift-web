...
const TERM_HELP_BY_KEY: Record<string, string> = {
  ...
  "structured-data": "Structured data (JSON-LD) drives rich results and clarifies entities; covers both validity and entity coverage (Organization/WebSite/FAQPage).",
  ...
  "twitter-card-coverage": "Twitter card tags control how your page looks when shared on X/Twitter.",
  "social-tags": "Open Graph tags (og:*) control page title/description/image/type/locale previews on social platforms.",
  ...
  "keyword-density": "How often and how naturally target and related keywords appear in body copy.",
  "above-the-fold-relevance": "Whether the first screen clearly matches the search query and page intent.",
  "content-depth": "Whether the page has enough topical depth versus typical competitors.",
  "anchor-text-quality": "Quality of link text, empty anchors, and icon links without labels.",
  "semantic-landmarks": "header/main/nav/footer/section usage and a logical outline.",
  favicon: "Favicon, apple-touch, and other small icons declared for browsers.",
  "blog-cannibalization": "Off-topic or competing modules that may dilute the main page’s focus.",
  "faq-section": "FAQ blocks, questions/answers, and long-tail question coverage on-page.",
  "trust-signals": "Metrics, reviews, press, credentials, and E-E-A-T style proof.",
  "url-structure": "Clean URL path, query params, and tracking fragments for the URL.",
};
