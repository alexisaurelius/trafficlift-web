...
const TERM_HELP_BY_KEY: Record<string, string> = {
  ...
  "open-graph": "Open Graph tags (og:*) for social and messaging previews.",
  ...
  "performance-hints": "Heavy assets, LCP image risk, and other Web Vitals-related red flags (qualitative).",
